%MDL_motomanDIA10 Create model of Motoman DIA10 manipulator
%
%      mdl_motomandia10
%
...
L(3) = Link([ 0     0	    E4        -pi/2   0], 'standard');
L(4) = Link([ 0     M5     E5        0       0], 'standard');


Tetis= SerialLink(L, 'name', 'Tetis', ...
...
qr = [0 -pi/4 pi/2 0 ]; % ready pose, arm up
qc = [0 -pi/2 0 0];
qh = [pi 0 pi pi];
